...
public:
	BlockColor();
	explicit BlockColor(unsigned char r, unsigned char g, unsigned char b);
	explicit BlockColor(unsigned char r, unsigned char g, unsigned char b, unsigned char alpha);
	explicit BlockColor(glm::vec3 color);
